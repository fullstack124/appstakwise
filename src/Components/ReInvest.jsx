        ...
        <>
            <div className='flex items-center justify-center space-x-4 my-5'>
                <div className='p-3 rounded-full' style={{ backgroundImage: "linear-gradient(90deg,#344675,#263148)" }}>
                    <img className='w-10' src="https://app.stakewise.io/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Freth2.58720906.png&w=256&q=75" alt="" />
                </div>
            ...
            <div className=''>
                <div className='flex items-center border border-[#2b3553] space-x-7   rounded-lg mx-4'>
                    <div className='flex items-center px-4 space-x-2'>
                        <img src="https://app.stakewise.io/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Freth2.58720906.png&w=256&q=75" alt="" className='w-5' />
                        <span className='font-semibold text-white text-xl'>rETH2</span>
                    </div>
            ...
            <div className='mt-10 text-center space-y-3'>
                <h1 className='space-x-3'><span className='text-blue-500 text-lg'>You receive </span> <span className='text-white font-medium text-md'>0.00 sETH2</span></h1>
            </div>
            <div className='text-center sm:w-10/12 w-full mx-auto my-2 text-white'>
            You will reinvest your rewards by utilizing the Uniswap Liquidity Poo
            </div>
